            ...
            <div className="container mx-auto py-10 flex gap-5 ">
                ...
                <div className="flex-1 space-y-5">
                    ...
                    <div className="bg-white px-5 py-6 rounded-md shadow space-y-3">
                        ...
                        <div className=" grid grid-cols-3 gap-5  
                        ">
                            <div className="card-body items-center text-center bg-slate-100 rounded-md cursor-pointer transition duration-150 hover:shadow-md active:scale-95 active:shadow-inner ">
